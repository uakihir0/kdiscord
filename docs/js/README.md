...
This repository is the npm repository for [kdiscord]. [kdiscord] is a Discord client library created using Kotlin Multiplatform.
...
Please check the [branch list](https://github.com/uakihir0/kdiscord.js/branches) to find the branch corresponding to the version.

```shell
npm add uakihir0/kdiscord.js
or
npm add uakihir0/kdiscord.js#{{BRANCH_NAME}}
```
